...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.err.println("Erreur à l'initisation du serveur : ");
			e.printStackTrace();
		}
		...
		try {
			...
			System.err.println("Impossible de créer l'adresse localhost : ");
			e.printStackTrace();
		}
		try {
			new Thread(new Client(srv_adr, port_serveur)).start();
		} catch (SocketException e) {
			System.err.println("Erreur à l'initisation du client : ");
			e.printStackTrace();
		}
